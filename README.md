...
- `quote_requests.csv`: Incoming customer requests used to build quoting logic (`mood`, `job`, `need_size`, `event`, `response`)
- `quote_requests_sample.csv`: A set of simulated test cases to evaluate your system (includes `mood` for order-recommendation pricing signals)
